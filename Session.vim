...
badd +36 src/app/models/standard.ts
badd +58 src/app/cards/cards-list/cards-list.component.ts
badd +29 src/app/layout/mushrooms/mushrooms.page.ts
argglobal
%argdel
...
setlocal fdn=20
setlocal fen
let s:l = 29 - ((24 * winheight(0) + 20) / 41)
